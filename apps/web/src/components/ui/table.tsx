...
function TableHeader({ className, ...props }: React.ComponentProps<"thead">) {
  return (
    <thead
      ...
      className={cn("bg-secondary text-muted-foreground [&_tr]:border-b", className)}
      {...props}
    />
  )
}
...
function TableRow({ className, ...props }: React.ComponentProps<"tr">) {
  return (
    <tr
      data-slot="table-row"
      className={cn(
        "border-b border-border transition-colors hover:bg-secondary/70 has-aria-expanded:bg-secondary data-[state=selected]:bg-[var(--surface-selected)]",
        className
      )}
      {...props}
    />
